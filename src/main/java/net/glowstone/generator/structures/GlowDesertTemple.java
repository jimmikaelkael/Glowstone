...
public class GlowDesertTemple extends GlowTemplePiece {
    ...
    public boolean generate(World world, Random random, BlockStateDelegate delegate) {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            // side
            builder.fill(new Vector(0 + i * 20, 20, 1), new Vector(0 + i * 20, 21, 1), Material.SANDSTONE, 2);
            builder.fill(new Vector(0 + i * 20, 20, 2), new Vector(0 + i * 20, 21, 2), Material.STAINED_CLAY, 1);
            builder.fill(new Vector(0 + i * 20, 20, 3), new Vector(0 + i * 20, 21, 3), Material.SANDSTONE, 2);
            builder.setBlock(new Vector(0 + i * 20, 22, 1), Material.STAINED_CLAY, 1);
            builder.setBlock(new Vector(0 + i * 20, 22, 2), Material.SANDSTONE, 1);
            builder.setBlock(new Vector(0 + i * 20, 22, 3), Material.STAINED_CLAY, 1);
            builder.setBlock(new Vector(0 + i * 20, 23, 1), Material.SANDSTONE, 2);
            builder.setBlock(new Vector(0 + i * 20, 23, 2), Material.STAINED_CLAY, 1);
            builder.setBlock(new Vector(0 + i * 20, 23, 3), Material.SANDSTONE, 2);
            builder.setBlock(new Vector(0 + i * 20, 24, 1), Material.STAINED_CLAY, 1);
            builder.setBlock(new Vector(0 + i * 20, 24, 2), Material.SANDSTONE, 1);
            builder.setBlock(new Vector(0 + i * 20, 24, 3), Material.STAINED_CLAY, 1);
            builder.fill(new Vector(0 + i * 20, 25, 1), new Vector(0 + i * 20, 25, 3), Material.STAINED_CLAY, 1);
            builder.fill(new Vector(0 + i * 20, 26, 1), new Vector(0 + i * 20, 26, 3), Material.SANDSTONE, 2);
        }
        // front entrance
        ...
        builder.createRandomItemsContainer(new Vector(10, 3, 8), random, chestContent, new Chest(getRelativeFacing(BlockFace.SOUTH)), random.nextInt(5) + 2);
        builder.createRandomItemsContainer(new Vector(12, 3, 10), random, chestContent, new Chest(getRelativeFacing(BlockFace.WEST)), random.nextInt(5) + 2);
        builder.createRandomItemsContainer(new Vector(10, 3, 12), random, chestContent, new Chest(getRelativeFacing(BlockFace.NORTH)), random.nextInt(5) + 2);
        builder.createRandomItemsContainer(new Vector(8, 3, 10), random, chestContent, new Chest(getRelativeFacing(BlockFace.EAST)), random.nextInt(5) + 2);
